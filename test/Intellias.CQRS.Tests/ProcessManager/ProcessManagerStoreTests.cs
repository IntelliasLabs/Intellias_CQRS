...
{
    public class ProcessManagerStoreTests : StorageAccountTestBase
    {
        private ProcessManagerStore storage;
        private Fixture fixture;

        public ProcessManagerStoreTests(StorageAccountFixture storageFixture)
        {
            ...
            storage = new ProcessManagerStore(options);
            fixture = new Fixture();
        }
